...
ggsave("plots/rem-valence-reactivity correlation.pdf", width = 12, height = 9)
...
ggsave("plots/rem-arousal-reactivity correlation.pdf", width = 12, height = 9)
...
ggsave("plots/rem-valence-regulation correlation.pdf", width = 12, height = 9)
...
ggsave("plots/rem-arousal-regulation correlation.pdf", width = 12, height = 9)
```

```{r visualization 4 SWS and reactivity}
#### SWS and valence-reactivity ####
p_sws1 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_n3, watch_val_rating, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "SWS and valence-reactivity (REM > 0)")

p_sws2 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
...
p_sws3 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_n3, watch_arou_rating, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "SWS and arousal-reactivity (REM > 0)")

p_sws4 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
...
ggsave("plots/sws-reactivity correlation.pdf", width = 12, height = 9)
```
...
ggsave("plots/sws-valence-regulation correlation.pdf", width = 12, height = 9)
...
ggsave("plots/sws-arousal-regulation correlation.pdf", width = 12, height = 9)

```

```{r visualization 6 TST}
### TST (total sleep time) and reactivity ####
p_tst1 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_tst, watch_val_rating, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "Total sleep time and valence-reactivity (REM > 0)")

p_tst2 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_tst, watch_arou_rating, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "Total sleep time and arousal-reactivity (REM > 0)")

### TST and regulation ####
p_tst3 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_tst, reappraise_val_change, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "Total sleep time and reappraisal-valence change (REM > 0)")

p_tst4 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_tst, distract_val_change, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "Total sleep time and distraction-valence change (REM > 0)")

p_tst5 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_tst, reappraise_arou_change, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "Total sleep time and reappraisal-arousal change (REM > 0)")

p_tst6 <- ggplot(df.er_psg %>% filter(psg_rem > 0),
       aes(psg_tst, distract_arou_change, color = intensity))+
  geom_point(alpha = .8)+
  geom_smooth(method = "lm")+
  labs(title = "Total sleep time and distraction-arousal change (REM > 0)")

plot_grid(p_tst1, p_tst2, p_tst3, p_tst4, p_tst5, p_tst6, ncol = 2)
ggsave("plots/tst-reactivity and regulation correlation.pdf", width = 12, height = 13.5)
...
# REM duration
with(df.er_psg %>% filter(intensity == "high", psg_rem > 0),
...
mod_rem3 <- lm(watch_val_rating ~ psg_rem+intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
mod_rem4 <- lm(watch_val_rating ~ psg_rem*intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
...
## interaction effect
mod_rem7 <- lm(watch_arou_rating ~ psg_rem+intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
mod_rem8 <- lm(watch_arou_rating ~ psg_rem*intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
