...
with(df.er_psg %>% filter(intensity == "low", psg_rem > 0),
     cor.test(psg_tst, watch_val_rating))
with(df.er_psg %>% filter(intensity == "low", psg_rem > 0),
     cor.test(psg_tst, watch_arou_rating))
```
...
# interaction
mod_sws2 <- lm(watch_val_rating ~ psg_n3+intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
mod_sws3 <- lm(watch_val_rating ~ psg_n3*intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
...
# interaction
mod_sws5 <- lm(watch_arou_rating ~ psg_n3+intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
mod_sws6 <- lm(watch_arou_rating ~ psg_n3*intensity_num, 
               data = df.er_psg %>% filter(psg_rem > 0))
