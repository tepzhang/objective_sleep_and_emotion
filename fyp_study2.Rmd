...
df.emg_trial_matched <- df.emg_trial_matched %>% 
  filter(emg_corr_change < 15,
         participant != "5446") #only noise in EMG data

# average across trials
df.emg_ind <- df.emg_trial_matched %>% 
  group_by(participant, task, intensity) %>% 
