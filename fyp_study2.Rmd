...
#   3181 - 1,2,3 in the hypnogram data instead of N1, N2, N3
...
ggpairs(df.er_psg %>%
          ...
          select(psg_tst, psg_n1, psg_n2, psg_sws, psg_rem, 
                 watch_val_rating, watch_arou_rating)) +
  theme_minimal()


# ggsave("plots/psg_correlations.png", width = 9, height = 8)
