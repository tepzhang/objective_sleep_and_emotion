...
plot_grid(p_tst_mod1, p_tst_mod2)
ggsave("plots/tst-reactivity models.png", width = 10, height = 5)
...
## Explorative: Trial-level models and Bayesian models
...
```{r trial-level model comparison}
...
# ggsave("../../figures/trial_level_models.png", width = 8, height = 6)
```
